...
handoffs:
  - label: Ejecutar Análisis Estático Frontend
    ...
    prompt: Ejecuta /static-analysis <feature> frontend sobre los archivos que acabas de implementar. Sigue la skill static-analysis para analizar con SonarQube, generar reporte y reportar gate PASS/FAIL.
    send: false
...
| `/static-analysis` | `/static-analysis <feature> frontend` | Al finalizar implementación, antes de Fase 3 (Tests) |
