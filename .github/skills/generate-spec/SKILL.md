...
- [ ] Contrato API explícito si aplica (método, ruta `/api/v1/[controller]/[action]`, request, response, códigos HTTP)
- [ ] Alineada con arquitectura y stack (ASP.NET Core + C# + MongoDB + RabbitMQ)
...
- `## 2. DISEÑO` — modelos de datos, endpoints API (request/response/HTTP codes), arquitectura de capas
